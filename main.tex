...
% \renewcommand{\columnseprulecolor}{\color{linecolor}}
    ...
    {\color{linecolor} \hspace*{\fill}\rule{.5\textwidth}{.4pt}\hspace*{\fill}}

    \vspace*{-.17\textwidth}
    {\color{linecolor} \hspace*{\fill}\rule{.4pt}{.34\textwidth}\hspace*{\fill}}
    \vspace*{-.17\textwidth}
    ...
    \begin{multicols}{2}
        ...
        \vspace*{\baselineskip}
        \vspace*{4pt} % fix a small bug with colorboxes
